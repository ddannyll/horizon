...
export default function Experience () {
   return <section className="container mx-auto min-h-screen flex flex justify-center items-start gap-10">
    <motion.div
      initial={{ opacity: 0 }}
      ...
      <Timeline
        nodes={[
          ...
          },
          {
            ...
            description: "Lab assisted in COMP2041 - Software Construction Tools and Techniques."
          }
        ]}
      />
    </motion.div>
